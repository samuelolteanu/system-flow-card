...
return function(t){return!isNaN(parseFloat(t))&&!isNaN(Number(t))}(t)?Number(t):e}null===(ht=window.HTMLSlotElement)||void 0===ht||ht.prototype.assignedElements;var mt="0.1.0";console.groupCollapsed(`%c⚡ System Flow Card v${mt} is installed`,"color: #488fc2; font-weight: bold"),console.log("Readme:","https://github.com/flyrmyr/system-flow-card"),console.groupEnd();const pt=function(t,e,i){var s;return void 0===i&&(i=!1),function(){var o=[].slice.call(arguments),n=this,r=i&&!s;clearTimeout(s),s=setTimeout((function(){s=null,i||t.apply(n,o)}),e),r&&t.apply(n,o)}}((t=>{console.log(`%c⚡ System Flow Card v${mt} %cError: ${t}`,"color: #488fc2; font-weight: bold","color: #b33a3a; font-weight: normal")}),500);console.info("%c SYSTEM-FLOW-CARD 2.1-FIXED IS LOADED ","background: #4caf50; color: #fff; font-weight: bold;");let vt=class extends lt{constructor(){super(...arguments),this._config={},this.getEntity=t=>{const e=t?this.hass.states[t]:void 0;if(e&&e.state)return e;pt(`entity "${null!=t?t:"Unknown"}" is not available or misconfigured`)},this.previousDur={},this.getElementEntityId=t=>t.value?"string"==typeof t.value?t.value:t.value.toSystem||t.value.fromSystem||void 0:void 0,this.getElementEntity=t=>this.getEntity(this.getElementEntityId(t)),this.getElementIconId=t=>{if(t.icon)return t.icon;const e=this.getElementEntity(t);return e&&e?function(t){if(!t)return"mdi:bookmark";if(t.attributes.icon)return t.attributes.icon;var e=function(t){return t.substr(0,t.indexOf("."))}(t.entity_id);return e in r?r[e](t):o(e,t.state)}(e):"mdi:eye"},this.getElementColor=t=>t.color?t.color:"var(--primary-text-color)",this.getElementUnit=t=>t.unit||this.getEntityUnit(this.getElementEntity(t)),this.getEntityUnit=t=>{const e="string"==typeof t?this.getEntity(t):t;if(e)return e.attributes.unit_of_measurement},this.displayValue=(t,e=!1,i=null,s=!1)=>{let o=t;if("string"==typeof o){const t=Number(o);isNaN(t)||""===o.trim()||(o=t)}if(e&&"number"==typeof o&&(o=Math.abs(o)),"number"==typeof o){const t=10**("number"==typeof s?s:1);o=Math.round(o*t)/t}return i?`${o} ${i}`:o},this.getEntityValue=(t,e=!1,i=!1,s=!1)=>{const o="string"==typeof t?this.getEntity(t):t;if(!o)return;const n=null==o?void 0:o.state,r=i?this.getEntityUnit(o):null;return this.displayValue(n,e,r,s)},this.elementArrows=(t,e,i=null)=>{if(!t)return null;let s;switch(!0){case"top"===e&&t>0||"bottom"===e&&t<0:s="down";break;case"top"===e&&t<0||"bottom"===e&&t>0:s="up";break;case"left"===e&&t>0||"right"===e&&t<0:s="right";break;case"left"===e&&t<0||"right"===e&&t>0:s="left";break;default:s=""}return V`<ha-icon style="fill: ${i}; display: inline-block;" class="small" icon="mdi:arrow-${s}"></ha-icon>`},this.elementValueArrows=t=>V`
    <div class="value-row">
      ${t.calculations.systemTotal||t.display?V`
  ...
  `}}setConfig(t){if(!t.elements||!t.elements.length)throw new Error("At least one entity must be defined");["top","bottom"].forEach((e=>{if(t.elements.filter((t=>t.position===e)).length>2)throw new Error(`Maximum 2 elements allowed in ${e} row.`)})),this._config=Object.assign(Object.assign({},t),{speed:ut(t.speed,5)})}getCardSize(){return 3}render(){var t,e,i,s,o,n,r,l,a,c;if(!this._config||!this.hass)return V``;const{elements:d}=this._config;let h=0;const u=d.map((t=>{let e=0,i=null,s=0;const o=t.invert?-1:1;e="string"==typeof t.value?ut(this.getEntityValue(t.value))*o:ut(this.getEntityValue(t.value.toSystem)),"string"!=typeof t.value&&t.value.fromSystem&&(i=ut(this.getEntityValue(t.value.fromSystem))),s=e-(null!=i?i:0),t.exclude||(h-=s);const n="string"==typeof t.extra?{main:t.extra}:t.extra;return Object.assign(Object.assign({},t),{extra:n,calculations:{toSystem:e,fromSystem:i,systemTotal:s}})})),m="string"==typeof(null===(t=this._config.system)||void 0===t?void 0:t.extra)?{main:null===(e=this._config.system)||void 0===e?void 0:e.extra}:null===(i=this._config.system)||void 0===i?void 0:i.extra;let p;if((null===(s=this._config.system)||void 0===s?void 0:s.invert)&&(h*=-1),(null===(o=this._config.system)||void 0===o?void 0:o.override)&&(null===(n=this._config.system)||void 0===n?void 0:n.value)){const t=this.getEntity(this._config.system.value);t&&(p=t.state)}u.push(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({value:"system",display:p},(null===(r=this._config.system)||void 0===r?void 0:r.unit)?{unit:this._config.system.unit}:null),{icon:(null===(l=this._config.system)||void 0===l?void 0:l.icon)||"mdi:house"}),(null===(a=this._config.system)||void 0===a?void 0:a.extra)?{extra:this._config.system.extra}:null),(null===(c=this._config.system)||void 0===c?void 0:c.color)?{color:this._config.system.color}:null),{position:"middle",extra:m,calculations:{toSystem:h>0?h:0,fromSystem:h<0?h:0,systemTotal:h}}));const v={left:u.filter((t=>"left"===t.position)),top:u.filter((t=>"top"===t.position)),right:u.filter((t=>"right"===t.position)),bottom:u.filter((t=>"bottom"===t.position)),middle:u.filter((t=>"middle"===t.position))},f={left:"position: absolute; left: 0; top: 10px; width: calc(50% - 42px); height: calc(100% - 20px);",top:"position: absolute; left: 10px; top: 0; width: calc(100% - 20px); height: calc(50% - 42px);",right:"position: absolute; left: calc(50% + 42px); top: 10px; width: calc(50% - 42px); height: calc(100% - 20px);",bottom:"position: absolute; left: 10px; top: calc(50% + 42px); width: calc(100% - 20px); height: calc(50% - 42px);"},g={left:(t,e)=>`M 100 ${e}   C 50 ${e}    50 ${t}    0 ${t}`,top:(t,e)=>`M ${e} 100   C ${e} 50    ${t} 50    ${t} 0`,right:(t,e)=>`M 0 ${e}     C 50 ${e}    50 ${t}    100 ${t}`,bottom:(t,e)=>`M ${e} 0     C ${e} 50    ${t} 50    ${t} 100`},y=u.filter((t=>0!==t.calculations.systemTotal)).reduce(((t,e)=>t+Math.abs(e.calculations.systemTotal)),0)/u.length,$=Object.fromEntries(["left","top","right","bottom"].map((t=>{const e=v[t],i=1/e.length*100;return[t,e.map(((e,s)=>{var o,n;const r=`flow-${t}-${s}`,l=(s+1)*i-.5*i,a=50+-10*(1-l/50),c=g[t](l,a),d=e.calculations.systemTotal&&y?this._config.speed/(Math.abs(e.calculations.systemTotal)/y):0,h=null!==(n=null===(o=this.renderRoot)||void 0===o?void 0:o.querySelector(`#${r}`))&&void 0!==n?n:null;return h&&d&&this.previousDur[r]&&this.previousDur[r]!==d&&(h.pauseAnimations(),h.setCurrentTime(h.getCurrentTime()*(d/this.previousDur[r])),h.unpauseAnimations()),this.previousDur[r]=d,{flowId:r,element:e,path:c,dur:d}}))]})));return V`
      <ha-card .header=${this._config.title}>
        <div class="card-content">
          <div class="row" style="height:100%;">
            ...
            <div class="col">
              <div class="row">
                ${v.top.length?v.top.map((t=>this.elementToHtml(t))):V`<div class="spacer container-top"></div>`}
              </div>
              <div class="row">
                ${v.middle.map((t=>this.elementToHtml(t,!0)))}
              </div>
              <div class="row">
                ${v.bottom.length?v.bottom.map((t=>this.elementToHtml(t))):V`<div class="spacer container-bottom"></div>`}
              </div>
            </div>
            <div class="col">
            ...
            <div class="lines">
              ${_=$,b=(t,e)=>V`
                <svg xmlns="http://www.w3.org/2000/svg" style="${f[t]}" viewBox="0 0 100 100" preserveAspectRatio="none">
                  ${e.map((e=>{var i;return L`
                    ...
                    ${this.displayValue(e.element.calculations.systemTotal)&&V`
                        <svg xmlns="http://www.w3.org/2000/svg" style="${f[t]}" viewBox="0 0 100 100" preserveAspectRatio="none" id="${e.flowId}">
              ...
              `,Object.keys(_).map((t=>b(t,_[t])))}
            </div>
          </div>
        </div>
      </ha-card>
    `;var _,b}};vt.styles=((t,...e)=>{const i=1===t.length?t[0]:e.reduce(((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1]),t[0]);return new h(i,t,c)})`
    :host {
      --mdc-icon-size: 24px;
    }
    ha-card {
