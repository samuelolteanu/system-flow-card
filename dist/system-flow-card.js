 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var w;b.finalized=!0,b.elementProperties=new Map,b.elementStyles=[],b.shadowRootOptions={mode:"open"},null==g||g({ReactiveElement:b}),(null!==(m=p.reactiveElementVersions)&&void 0!==m?m:p.reactiveElementVersions=[]).push("1.6.1");const x=window,A=x.trustedTypes,E=A?A.createPolicy("lit-html",{createHTML:t=>t}):void 0,S=`lit$${(Math.random()+"").slice(9)}$`,C="?"+S,k=`<${C}>`,T=document,O=(t="")=>T.createComment(t),U=t=>null===t||"object"!=typeof t&&"function"!=typeof t,N=Array.isArray,P=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,M=/>/g,R=RegExp(">|[ \t\n\f\r](?:([^\\s\"'>=/]+)([ \t\n\f\r]*=[ \t\n\f\r]*(?:[^ \t\n\f\r\"'`<>=]|(\"|')|))|$)","g"),j=/'/g,I=/"/g,z=/^(?:script|style|textarea|title)$/i,D=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),V=D(1),L=D(2),B=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),W=new WeakMap,q=T.createTreeWalker(T,129,null,!1),X=(t,e)=>{const i=t.length-1,s=[];let o,n=2===e?"<svg>":"",r=P;for(let e=0;e<i;e++){const i=t[e];let l,a,c=-1,d=0;for(;d<i.length&&(r.lastIndex=d,a=r.exec(i),null!==a);)d=r.lastIndex,r===P?"!--"===a[1]?r=H:void 0!==a[1]?r=M:void 0!==a[2]?(z.test(a[2])&&(o=RegExp("</"+a[2],"g")),r=R):void 0!==a[3]&&(r=R):r===R?">"===a[0]?(r=null!=o?o:P,c=-1):void 0===a[1]?c=-2:(c=r.lastIndex-a[2].length,l=a[1],r=void 0===a[3]?R:'"'===a[3]?I:j):r===I||r===j?r=R:r===H||r===M?r=P:(r=R,o=void 0);const h=r===R&&t[e+1].startsWith("/>")?" ":"";n+=r===P?i+k:c>=0?(s.push(l),i.slice(0,c)+"$lit$"+i.slice(c)+S+h):i+S+(-2===c?(s.push(void 0),e):h)}const l=n+(t[i]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==E?E.createHTML(l):l,s]};class J{constructor({strings:t,_$litType$:e},i){let s;this.parts=[];let o=0,n=0;const r=t.length-1,l=this.parts,[a,c]=X(t,e);if(this.el=J.createElement(a,i),q.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(s=q.nextNode())&&l.length<r;){if(1===s.nodeType){if(s.hasAttributes()){const t=[];for(const e of s.getAttributeNames())if(e.endsWith("$lit$")||e.startsWith(S)){const i=c[n++];if(t.push(e),void 0!==i){const t=s.getAttribute(i.toLowerCase()+"$lit$").split(S),e=/([.?@])?(.*)/.exec(i);l.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?Q:"?"===e[1]?et:"@"===e[1]?it:G})}else l.push({type:6,index:o})}for(const e of t)s.removeAttribute(e)}if(z.test(s.tagName)){const t=s.textContent.split(S),e=t.length-1;if(e>0){s.textContent=A?A.emptyScript:"";for(let i=0;i<e;i++)s.append(t[i],O()),q.nextNode(),l.push({type:2,index:++o});s.append(t[e],O())}}}else if(8===s.nodeType)if(s.data===C)l.push({type:2,index:o});else{let t=-1;for(;-1!==(t=s.data.indexOf(S,t+1));)l.push({type:7,index:o}),t+=S.length-1}o++}}static createElement(t,e){const i=T.createElement("template");return i.innerHTML=t,i}}function K(t,e,i=t,s){var o,n,r,l;if(e===B)return e;let a=void 0!==s?null===(o=i._$Co)||void 0===o?void 0:o[s]:i._$Cl;const c=U(e)?void 0:e._$litDirective$;return(null==a?void 0:a.constructor)!==c&&(null===(n=null==a?void 0:a._$AO)||void 0===n||n.call(a,!1),void 0===c?a=void 0:(a=new c(t),a._$AT(t,i,s)),void 0!==s?(null!==(r=(l=i)._$Co)&&void 0!==r?r:l._$Co=[])[s]=a:i._$Cl=a),void 0!==a&&(e=K(t,a._$AS(t,e.values),a,s)),e}class Z{constructor(t,e){this.u=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}v(t){var e;const{el:{content:i},parts:s}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:T).importNode(i,!0);q.currentNode=o;let n=q.nextNode(),r=0,l=0,a=s[0];for(;void 0!==a;){if(r===a.index){let e;2===a.type?e=new Y(n,n.nextSibling,this,t):1===a.type?e=new a.ctor(n,a.name,a.strings,this,t):6===a.type&&(e=new st(n,this,t)),this.u.push(e),a=s[++l]}r!==(null==a?void 0:a.index)&&(n=q.nextNode(),r++)}return o}p(t){let e=0;for(const i of this.u)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Y{constructor(t,e,i,s){var o;this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=s,this._$Cm=null===(o=null==s?void 0:s.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cm}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=K(this,t,e),U(t)?t===F||null==t||""===t?(this._$AH!==F&&this._$AR(),this._$AH=F):t!==this._$AH&&t!==B&&this.g(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>N(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]))(t)?this.k(t):this.g(t)}O(t,e=this._$AB){return this._$AA.parentNode.insertBefore(t,e)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}g(t){this._$AH!==F&&U(this._$AH)?this._$AA.nextSibling.data=t:this.T(T.createTextNode(t)),this._$AH=t}$(t){var e;const{values:i,_$litType$:s}=t,o="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=J.createElement(s.h,this.options)),s);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.p(i);else{const t=new Z(o,this),e=t.v(this.options);t.p(i),this.T(e),this._$AH=t}}_$AC(t){let e=W.get(t.strings);return void 0===e&&W.set(t.strings,e=new J(t)),e}k(t){N(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,s=0;for(const o of t)s===e.length?e.push(i=new Y(this.O(O()),this.O(O()),this,this.options)):i=e[s],i._$AI(o),s++;s<e.length&&(this._$AR(i&&i._$AB.nextSibling,s),e.length=s)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cm=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class G{constructor(t,e,i,s,o){this.type=1,this._$AH=F,this._$AN=void 0,this.element=t,this.name=e,this._$AM=s,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=F}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,s){const o=this.strings;let n=!1;if(void 0===o)t=K(this,t,e,0),n=!U(t)||t!==this._$AH&&t!==B,n&&(this._$AH=t);else{const s=t;let r,l;for(t=o[0],r=0;r<o.length-1;r++)l=K(this,s[i+r],e,r),l===B&&(l=this._$AH[r]),n||(n=!U(l)||l!==this._$AH[r]),l===F?t=F:t!==F&&(t+=(null!=l?l:"")+o[r+1]),this._$AH[r]=l}n&&!s&&this.j(t)}j(t){t===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class Q extends G{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===F?void 0:t}}const tt=A?A.emptyScript:"";class et extends G{constructor(){super(...arguments),this.type=4}j(t){t&&t!==F?this.element.setAttribute(this.name,tt):this.element.removeAttribute(this.name)}}class it extends G{constructor(t,e,i,s,o){super(t,e,i,s,o),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=K(this,t,e,0))&&void 0!==i?i:F)===B)return;const s=this._$AH,o=t===F&&s!==F||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==F&&(s===F||o);o&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class st{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){K(this,t)}}const ot=x.litHtmlPolyfillSupport;null==ot||ot(J,Y),(null!==(w=x.litHtmlVersions)&&void 0!==w?w:x.litHtmlVersions=[]).push("2.6.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var nt,rt;class lt extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var s,o;const n=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:e;let r=n._$litPart$;if(void 0===r){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;n._$litPart$=r=new Y(e.insertBefore(O(),t),t,void 0,null!=i?i:{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return B}}lt.finalized=!0,lt._$litElement$=!0,null===(nt=globalThis.litElementHydrateSupport)||void 0===nt||nt.call(globalThis,{LitElement:lt});const at=globalThis.litElementPolyfillSupport;null==at||at({LitElement:lt}),(null!==(rt=globalThis.litElementVersions)&&void 0!==rt?rt:globalThis.litElementVersions=[]).push("3.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */
return function(t){return!isNaN(parseFloat(t))&&!isNaN(Number(t))}(t)?Number(t):e}null===(ht=window.HTMLSlotElement)||void 0===ht||ht.prototype.assignedElements;var mt="0.1.0";console.groupCollapsed(`%c⚡ System Flow Card v${mt} is installed`,"color: #488fc2; font-weight: bold"),console.log("Readme:","https://github.com/flyrmyr/system-flow-card"),console.groupEnd();const pt=function(t,e,i){var s;return void 0===i&&(i=!1),function(){var o=[].slice.call(arguments),n=this,r=i&&!s;clearTimeout(s),s=setTimeout((function(){s=null,i||t.apply(n,o)}),e),r&&t.apply(n,o)}}((t=>{console.log(`%c⚡ System Flow Card v${mt} %cError: ${t}`,"color: #488fc2; font-weight: bold","color: #b33a3a; font-weight: normal")}),500);console.info("%c SYSTEM-FLOW-CARD 2.1-FIXED IS LOADED ","background: #4caf50; color: #fff; font-weight: bold;");let vt=class extends lt{constructor(){super(...arguments),this._config={},this.getEntity=t=>{const e=t?this.hass.states[t]:void 0;if(e&&e.state)return e;pt(`entity "${null!=t?t:"Unknown"}" is not available or misconfigured`)},this.previousDur={},this.getElementEntityId=t=>t.value?"string"==typeof t.value?t.value:t.value.toSystem||t.value.fromSystem||void 0:void 0,this.getElementEntity=t=>this.getEntity(this.getElementEntityId(t)),this.getElementIconId=t=>{if(t.icon)return t.icon;const e=this.getElementEntity(t);return e&&e?function(t){if(!t)return"mdi:bookmark";if(t.attributes.icon)return t.attributes.icon;var e=function(t){return t.substr(0,t.indexOf("."))}(t.entity_id);return e in r?r[e](t):o(e,t.state)}(e):"mdi:eye"},this.getElementColor=t=>t.color?t.color:"var(--primary-text-color)",this.getElementUnit=t=>t.unit||this.getEntityUnit(this.getElementEntity(t)),this.getEntityUnit=t=>{const e="string"==typeof t?this.getEntity(t):t;if(e)return e.attributes.unit_of_measurement},this.displayValue=(t,e=!1,i=null,s=!1)=>{let o=t;if("string"==typeof o){const t=Number(o);isNaN(t)||""===o.trim()||(o=t)}if(e&&"number"==typeof o&&(o=Math.abs(o)),"number"==typeof o){const t=10**("number"==typeof s?s:1);o=Math.round(o*t)/t}return i?`${o} ${i}`:o},this.getEntityValue=(t,e=!1,i=!1,s=!1)=>{const o="string"==typeof t?this.getEntity(t):t;if(!o)return;const n=null==o?void 0:o.state,r=i?this.getEntityUnit(o):null;return this.displayValue(n,e,r,s)},this.elementArrows=(t,e,i=null)=>{if(!t)return null;let s;switch(!0){case"top"===e&&t>0||"bottom"===e&&t<0:s="down";break;case"top"===e&&t<0||"bottom"===e&&t>0:s="up";break;case"left"===e&&t>0||"right"===e&&t<0:s="right";break;case"left"===e&&t<0||"right"===e&&t>0:s="left";break;default:s=""}return V`<ha-icon style="fill: ${i}; display: inline-block;" class="small" icon="mdi:arrow-${s}"></ha-icon>`},this.elementValueArrows=t=>V`
    <div class="value-row">
      ${t.calculations.systemTotal?V`
          ${["left","middle"].includes(t.position)?null:this.elementArrows(t.calculations.systemTotal,t.position,this.getElementColor(t))}
          <span style="white-space: nowrap;">${this.displayValue(t.calculations.systemTotal,"middle"!==t.position,this.getElementUnit(t),0)}</span>
          ${"left"===t.position?this.elementArrows(t.calculations.systemTotal,t.position,this.getElementColor(t)):null}
        `:null}
    </div>
  `,this.elementToHtml=(t,e=!1)=>{var i,s,o,n,r,l,a,c,d;return V`
    ...
    ">
      <div class="circle" style="border-color: ${this.getElementColor(t)}">
        ...
        ${""}
        ${"bottom"===t.position?this.elementValueArrows(t):V`<div class="value-row">${(null===(s=t.extra)||void 0===s?void 0:s.main)?this.getEntityValue(null===(o=t.extra)||void 0===o?void 0:o.main,!1,!0):" "}</div>`}
        ...
        <div class="icon-row">
          ...
          <ha-icon style="width: 24px; height: 24px; fill: ${this.getElementColor(t)}" icon="${this.getElementIconId(t)}"></ha-icon>
        ...
        ${""}
        ${"bottom"===t.position?V`<div class="value-row">${(null===(c=t.extra)||void 0===c?void 0:c.main)?this.getEntityValue(null===(d=t.extra)||void 0===d?void 0:d.main,!1,!0):" "}</div>`:this.elementValueArrows(t)}
      </div>
    </div>
  `}}setConfig(t){if(!t.elements||!t.elements.length)throw new Error("At least one entity must be defined");["top","bottom"].forEach((e=>{if(t.elements.filter((t=>t.position===e)).length>2)throw new Error(`Maximum 2 elements allowed in ${e} row.`)})),this._config=Object.assign(Object.assign({},t),{speed:ut(t.speed,5)})}getCardSize(){return 3}render(){var t,e,i,s,o,n,r,l;if(!this._config||!this.hass)return V``;const{elements:a}=this._config;let c=0;const d=a.map((t=>{let e=0,i=null,s=0;const o=t.invert?-1:1;e="string"==typeof t.value?ut(this.getEntityValue(t.value))*o:ut(this.getEntityValue(t.value.toSystem)),"string"!=typeof t.value&&t.value.fromSystem&&(i=ut(this.getEntityValue(t.value.fromSystem))),s=e-(null!=i?i:0),t.exclude||(c-=s);const n="string"==typeof t.extra?{main:t.extra}:t.extra;return Object.assign(Object.assign({},t),{extra:n,calculations:{toSystem:e,fromSystem:i,systemTotal:s}})})),h="string"==typeof(null===(t=this._config.system)||void 0===t?void 0:t.extra)?{main:null===(e=this._config.system)||void 0===e?void 0:e.extra}:null===(i=this._config.system)||void 0===i?void 0:i.extra;(null===(s=this._config.system)||void 0===s?void 0:s.invert)&&(c*=-1),d.push(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({value:"system"},(null===(o=this._config.system)||void 0===o?void 0:o.unit)?{unit:this._config.system.unit}:null),{icon:(null===(n=this._config.system)||void 0===n?void 0:n.icon)||"mdi:house"}),(null===(r=this._config.system)||void 0===r?void 0:r.extra)?{extra:this._config.system.extra}:null),(null===(l=this._config.system)||void 0===l?void 0:l.color)?{color:this._config.system.color}:null),{position:"middle",extra:h,calculations:{toSystem:c>0?c:0,fromSystem:c<0?c:0,systemTotal:c}}));const u={left:d.filter((t=>"left"===t.position)),top:d.filter((t=>"top"===t.position)),right:d.filter((t=>"right"===t.position)),bottom:d.filter((t=>"bottom"===t.position)),middle:d.filter((t=>"middle"===t.position))},m={left:"position: absolute; left: 0; top: 10px; width: calc(50% - 42px); height: calc(100% - 20px);",top:"position: absolute; left: 10px; top: 0; width: calc(100% - 20px); height: calc(50% - 42px);",right:"position: absolute; left: calc(50% + 42px); top: 10px; width: calc(50% - 42px); height: calc(100% - 20px);",bottom:"position: absolute; left: 10px; top: calc(50% + 42px); width: calc(100% - 20px); height: calc(50% - 42px);"},p={left:(t,e)=>`M 100 ${e}   C 50 ${e}    50 ${t}    0 ${t}`,top:(t,e)=>`M ${e} 100   C ${e} 50    ${t} 50    ${t} 0`,right:(t,e)=>`M 0 ${e}     C 50 ${e}    50 ${t}    100 ${t}`,bottom:(t,e)=>`M ${e} 0     C ${e} 50    ${t} 50    ${t} 100`},v=d.filter((t=>0!==t.calculations.systemTotal)).reduce(((t,e)=>t+Math.abs(e.calculations.systemTotal)),0)/d.length,f=Object.fromEntries(["left","top","right","bottom"].map((t=>{const e=u[t],i=1/e.length*100;return[t,e.map(((e,s)=>{var o,n;const r=`flow-${t}-${s}`,l=(s+1)*i-.5*i,a=50+-10*(1-l/50),c=p[t](l,a),d=e.calculations.systemTotal&&v?this._config.speed/(Math.abs(e.calculations.systemTotal)/v):0,h=null!==(n=null===(o=this.renderRoot)||void 0===o?void 0:o.querySelector(`#${r}`))&&void 0!==n?n:null;return h&&d&&this.previousDur[r]&&this.previousDur[r]!==d&&(h.pauseAnimations(),h.setCurrentTime(h.getCurrentTime()*(d/this.previousDur[r])),h.unpauseAnimations()),this.previousDur[r]=d,{flowId:r,element:e,path:c,dur:d}}))]})));return V`
      <ha-card .header=${this._config.title}>
        <div class="card-content">
          <div class="row" style="height:100%;">
            <div class="col">
              <div class="spacer container-left"></div>
              ${u.left.map((t=>this.elementToHtml(t)))}
              <div class="spacer container-left"></div>
            </div>
            <div class="col">
              <div class="row">
                ${u.top.length?u.top.map((t=>this.elementToHtml(t))):V`<div class="spacer container-top"></div>`}
              </div>
              <div class="row">
                ${u.middle.map((t=>this.elementToHtml(t,!0)))}
              </div>
              <div class="row">
                ${u.bottom.length?u.bottom.map((t=>this.elementToHtml(t))):V`<div class="spacer container-bottom"></div>`}
              </div>
            </div>
            <div class="col">
              <div class="spacer container-right"></div>
              ${u.right.map((t=>this.elementToHtml(t)))}
              <div class="spacer container-right"></div>
            <div class="lines">
              ${g=f,y=(t,e)=>V`
                <svg xmlns="http://www.w3.org/2000/svg" style="${m[t]}" viewBox="0 0 100 100" preserveAspectRatio="none">
                  ${e.map((e=>{var i;return L`
                    ...
                    ${this.displayValue(e.element.calculations.systemTotal)&&V`
                        <svg xmlns="http://www.w3.org/2000/svg" style="${m[t]}" viewBox="0 0 100 100" preserveAspectRatio="none" id="${e.flowId}">
